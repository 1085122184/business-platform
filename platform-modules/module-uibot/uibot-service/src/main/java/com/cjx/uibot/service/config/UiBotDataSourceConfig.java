...
@EnableJpaRepositories(
        basePackages = {"com.cjx.uibot.service.repository.uibot","com.cjx.common.jpa.repository"},  // 从数据源的Repository包路径
        entityManagerFactoryRef = "uiBotEntityManagerFactory",
        transactionManagerRef = "uiBotTransactionManager"
)
public class UiBotDataSourceConfig {
    @Value("${spring.datasource.ui-bot.jdbc-url}")
    private String jdbcUrl;

    @Value("${spring.datasource.ui-bot.username}")
    private String username;

    @Value("${spring.datasource.ui-bot.password}")
    private String password;

    @Value("${spring.datasource.ui-bot.driver-class-name}")
    private String driverClassName;

    @Value("${spring.datasource.ui-bot.hikari.minimum-idle:3}")
    private int minimumIdle;

    @Value("${spring.datasource.ui-bot.hikari.maximum-pool-size:10}")
    private int maximumPoolSize;

    @Bean(name = "uiBotDataSource")
    public DataSource uiBotDataSource() {
        System.out.println("========== Creating UIBot DataSource ==========");
        ...
        dataSource.setPoolName("UiBotHikariPool");
    ...
    public LocalContainerEntityManagerFactoryBean uiBotEntityManagerFactory(
        ...
        factory.setPackagesToScan("com.cjx.uibot.service.entity.uibot","com.cjx.common.jpa.entity");
        factory.setPersistenceUnitName("uiBotPersistenceUnit");
    ...
    public PlatformTransactionManager uiBotTransactionManager(
            @Qualifier("uiBotEntityManagerFactory") EntityManagerFactory entityManagerFactory) {
