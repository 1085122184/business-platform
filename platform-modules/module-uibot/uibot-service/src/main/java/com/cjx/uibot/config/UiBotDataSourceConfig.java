...
@EnableJpaRepositories(
        basePackages = {"com.cjx.uibot.repository.uibot","com.cjx.common.jpa.repository"},  // 从数据源的Repository包路径
...
public class UiBotDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean uiBotEntityManagerFactory(
        ...
        factory.setPackagesToScan("com.cjx.uibot.entity.uibot","com.cjx.common.jpa.entity");
