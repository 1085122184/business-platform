package com.cjx.diffchecker.service.config;

import com.cjx.diffchecker.service.config.properties.BipDataSourceProperties;
...
@EnableJpaRepositories(
        basePackages = "com.cjx.diffchecker.service.repository.bip",  // 从数据源的Repository包路径
...
public class BipDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean bipEntityManagerFactory(
        ...
        factory.setPackagesToScan("com.cjx.diffchecker.service.entity.bip");
