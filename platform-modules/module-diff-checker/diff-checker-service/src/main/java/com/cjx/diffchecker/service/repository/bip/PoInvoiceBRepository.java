package com.cjx.diffchecker.service.repository.bip;

import com.cjx.diffchecker.service.dto.InvoiceSummaryDTO;
import com.cjx.diffchecker.service.entity.bip.PoInvoiceB;
...
public interface PoInvoiceBRepository extends JpaRepository<PoInvoiceB, String> {
    ...
    @Query("SELECT new com.cjx.diffchecker.service.dto.InvoiceSummaryDTO(sum(i.ntax),sum(i.nmny)) " +
            "FROM PoInvoiceB i " +
